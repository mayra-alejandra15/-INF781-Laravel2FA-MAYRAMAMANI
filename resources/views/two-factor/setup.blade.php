        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('two-factor.disable')}}">
                    @csrf
                    <button type="submit" class="bg-red-600 hover:bg-red-700 text-white fontbold py-2 px-4 rounded"
...
mb-1">
                        ...
                        <input type="text" name="code" maxlength="6"
                            ...
                            class="border border-gray-300 rounded px-3 py-2 w40 text-center tracking-widest text-lg
 @error('code') border-red-500 @enderror"
                    ...
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-700 text-white fontbold py-2 px-4 rounded">
                        Activar 2FA
                    </button>
                </form>
                @endif
